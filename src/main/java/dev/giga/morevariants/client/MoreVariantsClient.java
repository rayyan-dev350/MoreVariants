...
import dev.giga.morevariants.client.renderer.RootedPearlEntityRenderer;
...
public class MoreVariantsClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        EntityRendererRegistry.register(ModEntityTypes.ROOTED_PEARL, RootedPearlEntityRenderer::new);
    }
}
